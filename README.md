...
24. Hooks with Object - HooksWithObject file in hooks folder
...
25. Hooks with array
26. useEffect - will execute everytime the component renders/re-renders. Just an replacement of componentDidMount/componentDidUpdate in class components. Advantage over here is instead of using 2 lifecycle methods in class components, we can use this useEffect only once in functional component.
--------------------------------------------
